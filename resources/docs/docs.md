...
* Update the connection parameters for the database in the `bed-time.db.core` namespace of your application.
...
Request middleware functions are located under the `bed-time.middleware` namespace.
